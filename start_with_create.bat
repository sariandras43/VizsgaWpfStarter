...
powershell -Command "(Get-Content 'MainWindow.xaml') -replace 'VizsgaWpfStarter.MainWindow', '%projectName%.MainWindow' | Set-Content 'MainWindow.xaml'"
powershell -Command "(Get-Content 'MainWindow.xaml') -replace 'clr-namespace:VizsgaWpfStarter', 'clr-namespace:%projectName%' | Set-Content 'MainWindow.xaml'"
...
powershell -Command "(Get-Content 'MainWindow.xaml.cs') -replace 'VizsgaWpfStarter', '%projectName%' | Set-Content 'MainWindow.xaml.cs'"
...
powershell -Command "(Get-Content 'Database.cs') -replace 'VizsgaWpfStarter', '%projectName%' | Set-Content 'Database.cs'"
