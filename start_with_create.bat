...
powershell -ep Bypass -Command "(Get-Content 'MainWindow.xaml') -replace 'VizsgaWpfStarter.MainWindow', '%projectName%.MainWindow' | Set-Content 'MainWindow.xaml' -Encoding utf8"
powershell -ep Bypass -Command "(Get-Content 'MainWindow.xaml') -replace 'clr-namespace:VizsgaWpfStarter', 'clr-namespace:%projectName%' | Set-Content 'MainWindow.xaml' -Encoding utf8"
...
powershell -ep Bypass -Command "(Get-Content 'MainWindow.xaml.cs') -replace 'VizsgaWpfStarter', '%projectName%' | Set-Content 'MainWindow.xaml.cs' -Encoding utf8"
...
powershell -ep Bypass -Command "(Get-Content 'Database.cs') -replace 'VizsgaWpfStarter', '%projectName%' | Set-Content 'Database.cs' -Encoding utf8"
